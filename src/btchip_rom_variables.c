...
unsigned char const DISPATCHER_CLA[] = {
    ...
    BTCHIP_CLA, // btchip_apdu_use_btcv_signature_password
};
...
unsigned char const DISPATCHER_INS[] = {
    ...
    BTCHIP_INS_USE_BTCV_SIGNATURE_PASSWORD // btchip_apdu_use_btcv_signature_password
};
...
unsigned char const DISPATCHER_DATA_IN[] = {
    ...
    1, // btchip_apdu_use_btcv_signature_password
};
...
apduProcessingFunction const DISPATCHER_FUNCTIONS[] = {
    ...
    btchip_apdu_use_btcv_signature_password,
};
